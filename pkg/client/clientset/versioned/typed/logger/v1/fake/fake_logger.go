...
var loggersResource = schema.GroupVersionResource{Group: "example.com", Version: "v1", Resource: "loggers"}

var loggersKind = schema.GroupVersionKind{Group: "example.com", Version: "v1", Kind: "Logger"}
...
func (c *FakeLoggers) Get(name string, options v1.GetOptions) (result *loggerv1.Logger, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(loggersResource, c.ns, name), &loggerv1.Logger{})

	if obj == nil {
		return nil, err
	}
	return obj.(*loggerv1.Logger), err
}
...
func (c *FakeLoggers) List(opts v1.ListOptions) (result *loggerv1.LoggerList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(loggersResource, loggersKind, c.ns, opts), &loggerv1.LoggerList{})
	...
	list := &loggerv1.LoggerList{ListMeta: obj.(*loggerv1.LoggerList).ListMeta}
	for _, item := range obj.(*loggerv1.LoggerList).Items {
...
func (c *FakeLoggers) Create(logger *loggerv1.Logger) (result *loggerv1.Logger, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(loggersResource, c.ns, logger), &loggerv1.Logger{})
...
func (c *FakeLoggers) Update(logger *loggerv1.Logger) (result *loggerv1.Logger, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(loggersResource, c.ns, logger), &loggerv1.Logger{})
...
func (c *FakeLoggers) UpdateStatus(logger *loggerv1.Logger) (*loggerv1.Logger, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(loggersResource, "status", c.ns, logger), &loggerv1.Logger{})
...
func (c *FakeLoggers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(loggersResource, c.ns, name), &loggerv1.Logger{})
...
func (c *FakeLoggers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(loggersResource, c.ns, listOptions)

	_, err := c.Fake.Invokes(action, &loggerv1.LoggerList{})
	return err
}
...
func (c *FakeLoggers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *loggerv1.Logger, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(loggersResource, c.ns, name, pt, data, subresources...), &loggerv1.Logger{})
